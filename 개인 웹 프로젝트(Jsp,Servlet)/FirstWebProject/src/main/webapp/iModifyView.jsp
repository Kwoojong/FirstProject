...
function submit_ajax() {
    ...
    var bId = $('#bId').val();
    $.ajax({
        url : '/FirstWebProject/iModify.do',
        type : 'POST',
        data : queryString,
        dataType: 'text',
       ...
       <tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <a class="btn btn-primary" href="iContentView.do?bId=${fContentView.bId}">취소</a> &nbsp;&nbsp;
                <a class="btn btn-primary" href="iListView.do?page=<%=session.getAttribute("cpage")%>">목록보기</a> &nbsp;&nbsp;
