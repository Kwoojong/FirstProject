    ...
    $.ajax({
        ...
        success : function(json) {
            ...
            if(result.code=="success"){
            	alert(result.desc);
            	window.location.replace('iListView.do');
...
<!-- 여기서부터 복사 -->
	...
	<table class="table">
        <form id="writeForm" > 
            ...
            <tr>
            	<form id="writeForm02" action="uploadAction.jsp" method="post" enctype="multipart/form-data">
            	<td>파일첨부</td>
            	<td><input type="file" name="file"> <input type="submit" value="파일업로드"></td>
            	</form>
            </tr>
            <tr>
                <td colspan="2">
                    <input type="button" class="btn btn-primary" value="글 제출" onclick="form_check();">&nbsp;&nbsp;
                    <a class="btn btn-primary" href="iListView.do">목록보기</a>
                </td>
            </tr>
