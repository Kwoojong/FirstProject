	...
	<table class="table table-bordered">
       ...
       <tr>
        ...
        <tr>
        	...
        	<div class="col-8"></div>
        	<div class="col-4">
                <a href="fModifyView.do?bId=${fContentView.bId}">수정</a>&nbsp;&nbsp;
                <a href="fListView.do?page=<%=session.getAttribute("cpage")%>">목록보기</a>&nbsp;&nbsp;
                <a href="fDelete.do?bId=${fContentView.bId}">삭제</a>
			</div>
			</div>
   </table>
   ...
   <table class="table">
   		...
   		<form id="reply_form${dto.bId}">
	        ...
	        function reply_delete${dto.bId}() {
	            ...
	            $.ajax({
	                url : '/FirstWebProject/freplydelete.do',
	                type : 'POST',
	                data : queryString,
	                dataType: 'text',
	                success : function(json) {
