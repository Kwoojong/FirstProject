...
function submit_ajax() {
    ...
    var bId = $('#bId').val();
    $.ajax({
        url : '/FirstWebProject/aModify.do',
        type : 'POST',
        data : queryString,
        dataType: 'text',
        success : function(json) {
            window.location.replace('aContentView.do?bId='+bId);
        }
    });
}
</script>
       ...
       <tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <a class="btn btn-primary" href="aContentView.do?bId=${fContentView.bId}">취소</a> &nbsp;&nbsp;
                <a class="btn btn-primary" href="aListView.do?page=<%=session.getAttribute("cpage")%>">목록보기</a> &nbsp;&nbsp;
